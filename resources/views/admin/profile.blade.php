...
<div class="relative max-w-3xl mx-auto px-6 py-10">
    ...
    <div class="absolute inset-0 -z-10">
        <span class="absolute -top-20 -right-20 w-72 h-72 bg-yellow-300/30 rounded-full blur-3xl"></span>
        <span class="absolute top-1/3 -left-20 w-72 h-72 bg-purple-300/30 rounded-full blur-3xl"></span>
        <span class="absolute bottom-0 right-1/3 w-72 h-72 bg-sky-300/30 rounded-full blur-3xl"></span>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur rounded-3xl p-8 shadow-xl border border-slate-100">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-6 mb-10">
            ...
            <div class="text-center sm:text-left">
                ...
                <span class="inline-block mt-2 px-4 py-1 bg-red-100 text-red-700 text-xs font-bold rounded-full">
                    ADMIN
                </span>
            </div>
        </div>

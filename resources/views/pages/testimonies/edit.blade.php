...
<body class="min-h-screen flex items-center justify-center px-4 py-10">
  <div class="card w-full max-w-lg p-8">
    <h1 class="text-2xl font-bold text-[#0f3b45] text-center mb-2">Edit Testimoni</h1>
    <p class="text-center text-slate-600 mb-6 text-sm">Perbarui pesanmu agar tetap relevan dan menginspirasi!</p>
    ...
    {{-- Form Edit Testimoni --}}
    <form action="{{ route('testimonies.update', $testimony->id) }}" method="POST" class="space-y-5">
      @csrf
      @method('PUT')
      ...
      <div>
        ...
        <textarea 
          ...
          placeholder="Edit pengalamanmu di sini...">{{ old('message', $testimony->message) }}</textarea>
      </div>
